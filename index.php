...
<tr><td align='center' colspan="2"><?= $es->qm ?></td><td align='center'><?= $es->nm ?></td><td align='center'colspan="3"><?= $es->qs ?></td><td align='center' colspan="2.5"><?= $es->ns ?></td><td align='center'><?= $es->qn ?></td><td align='center'><?= $es->nn ?></td></tr>
