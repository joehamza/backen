...
<center>
    ...
    <?php endforeach; ?>
       ...
       <?php $qe4=number_format($ent->ooo4,2,',','');
        ...
        <tr><th colspan='2'>Matin</th><th colspan='2'>Soir</th><th colspan='3'>Nuit</th></tr>
        <tr><th>Quantité</th><th>Camions</th><th colspan='1,5'>Quantité</th><th colspan='1,5'>Camions</th><th>Quantité</th><th>Camions</th></tr>
