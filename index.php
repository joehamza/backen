...
<center>
    ...
    <?php endforeach; ?>
       ...
       <?php $qe4=number_format($ent->ooo4,2,',','');
        ...
        <tr><th colspan='2'>Matin</th><th colspan='2'>Soir</th><th colspan='4'>Nuit</th></tr>
        <tr><th>Quantité</th><th>Camions</th><th>Quantité</th><th>Camions</th><th colspan='2'>Quantité</th><th colspan='2'>Camions</th></tr>
<tr><td align='center'><?= $es->qm ?></td><td align='center'><?= $es->nm ?></td><td align='center'><?= $es->qs ?></td><td align='center'><?= $es->ns ?></td><td align='center' colspan='2'><?= $es->qn ?></td><td align='center' colspan='2'><?= $es->nn ?></td></tr>
