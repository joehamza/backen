...
<tr><td align='center'><?= $es->qm ?></td><td align='center'><?= $es->nm ?></td><td colspan='2' align='center' colspan='2'><?= $es->qs ?></td><td align='center' colspan='2'><?= $es->ns ?></td><td align='center'><?= $es->qn ?></td><td align='center'><?= $es->nn ?></td></tr>
